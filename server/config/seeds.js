...
db.once("open", async () => {
  ...
  const products = await Product.insertMany([
    {
      name: "Shark",
      description: "A cute costume for a ferocious kity!",
    ...
    {
      name: "Bunny",
      description: "A cute costume for a snuggley kity!",
    ...
    {
      name: "Bee",
      description: "A cute costume for a gentle kity!",
    ...
    },
    {
      ...
      description: "Your kitties will love hunting these critters!",
      image: "mice.jpg",
      price: 3.99,
      quantity: 200,
    },
    {
      ...
      category: categories[1]._id,
      description:
        "Entertain your pet with hours of light show fun! Batteries not included.",
      image: "laser.jpg",
      price: 12.99,
      quantity: 50,
    },
    {
      name: "String Toy",
      category: categories[1]._id,
      description: "Hone your kitties coordination with this toy on a string",
    ...
    },
    {
      ...
      description:
        "Let your kitty run wild, scratch, play, and rest on this purrfect perch!",
